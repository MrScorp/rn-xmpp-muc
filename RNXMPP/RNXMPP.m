...
RCT_EXPORT_METHOD(connect:(NSString *)jid
    ...
    [[RNXMPPService sharedInstance] connect:jid withPassword:password auth:auth
                                   hostname:hostname port:port xmppDomainName:xmppDomainName
                                   resolver:resolve
                                   rejecter:reject];
}
...
RCT_EXPORT_METHOD(sendRoomMessage:(NSString *)roomJID password:(NSString *)password message:(NSString *)message )
{
    [RNXMPPService sharedInstance].delegate = self;
    [[RNXMPPService sharedInstance] sendRoomMessage:roomJID password:password message:message];
}

RCT_EXPORT_METHOD(sendRoomInvite:(NSString *)roomJID to:(NSString *)to reason:(NSString *)reason)
{
    [RNXMPPService sharedInstance].delegate = self;
    [[RNXMPPService sharedInstance] sendRoomInvite:roomJID to:to reason:reason];
}
